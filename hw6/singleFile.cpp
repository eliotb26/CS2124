...
//	const Noble* getBoss() const { return boss; }  //TODO check if need this 
//
...
//
//
//	bool runaway() {  //TODO check type cuz it doesnt say 
//		if (hired) {
//			boss->fire(*this);
//			boss = nullptr;
...
//	int strength;
//	Noble* boss; 
//	bool hired;  //TODO check if need this  and all of its methods
//};
//
//Noble class
//class Noble {
